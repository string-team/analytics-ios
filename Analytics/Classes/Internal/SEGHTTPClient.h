...
// This is now parametrised via the endpoint argument to SEGAnalyticsConfiguration 
 ...
 */
- (NSURLSessionUploadTask *)upload:(JSON_DICT)batch forWriteKey:(NSString *)writeKey forEndpoint:(NSString *)endpoint completionHandler:(void (^)(BOOL retry))completionHandler;
