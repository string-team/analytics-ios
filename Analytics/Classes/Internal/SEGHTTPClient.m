...
- (NSURLSessionUploadTask *)upload:(NSDictionary *)batch forWriteKey:(NSString *)writeKey forEndpoint:(NSString *)endpoint completionHandler:(void (^)(BOOL retry))completionHandler
{
